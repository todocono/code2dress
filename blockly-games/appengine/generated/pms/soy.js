...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">S-ciapatesta</span><span id="Games_maze">Labirint</span><span id="Games_bird">Bird</span><span id="Games_turtle">Bissa copera</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Argistré e lijé ai blòch.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Fé andé ël programa</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Buté torna coma al prinsipi</span><span id="Games_help">Giuté</span><span id="Games_dialogOk">Va bin</span><span id="Games_dialogCancel">Anulé</span><span id="Games_catLogic">Lògica</span><span id="Games_catLoops">Liasse</span><span id="Games_catMath">Matemàtica</span><span id="Games_catText">Test</span><span id="Games_catLists">Liste</span><span id="Games_catColour">Color</span><span id="Games_catVariables">Variàbij</span><span id="Games_catProcedures">Fonsion</span><span id="Games_httpRequestError">A-i é staje un problema con l\'arcesta.</span><span id="Games_linkAlert">Ch\'a partagia ij sò blòch grassie a sta liura: %1</span><span id="Games_hashError">An dëspias, \'%1 a corëspond a gnun programa salvà.</span><span id="Games_xmlError">A l\'é nen podusse carié so archivi salvà. Miraco a l\'é stàit creà con na version diferenta ëd Blockly?</span><span id="Games_listVariable">lista</span><span id="Games_textVariable">test</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult.  Would you like to skip it and go onto the next game?  You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Anulé</button><button id="abortOk" class="secondary">Va bin</button></div></div>';
};
