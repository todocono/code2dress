...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Bulmaca</span><span id="Games_maze">Labirent</span><span id="Games_bird">Bird</span><span id="Games_turtle">Kaplumbağa</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Blokları ve bağlantı adresini kaydet.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Programı Çalıştır</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Tekrar</span><span id="Games_help">Yardım</span><span id="Games_dialogOk">TAMAM</span><span id="Games_dialogCancel">İptal</span><span id="Games_catLogic">Mantık</span><span id="Games_catLoops">Döngüler</span><span id="Games_catMath">Matematik</span><span id="Games_catText">Metin</span><span id="Games_catLists">Listeler</span><span id="Games_catColour">Renk</span><span id="Games_catVariables">Değişkenler</span><span id="Games_catProcedures">İşlevler</span><span id="Games_httpRequestError">İstek ile ilgili bir problem var.</span><span id="Games_linkAlert">Bloklarını bu bağlantı ile paylaş:\n\n%1</span><span id="Games_hashError">Üzgünüz, \'%1\' hiç bir kaydedilmiş program ile uyuşmuyor.</span><span id="Games_xmlError">Kaydedilen dosyanız yüklenemiyor\nBlockly\'nin önceki sürümü ile kaydedilmiş olabilir mi?</span><span id="Games_listVariable">liste</span><span id="Games_textVariable">metin</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult.  Would you like to skip it and go onto the next game?  You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">İptal</button><button id="abortOk" class="secondary">TAMAM</button></div></div>';
};
