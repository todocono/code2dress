...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Miltamm</span><span id="Games_maze">Milendall</span><span id="Games_bird">Bird</span><span id="Games_turtle">Baot</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Enrollañ ha liammañ d\'ar bloc\'hadoù.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Lañsañ ar programm</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Adderaouekaat</span><span id="Games_help">Skoazell</span><span id="Games_dialogOk">Mat eo</span><span id="Games_dialogCancel">Nullañ</span><span id="Games_catLogic">Poell</span><span id="Games_catLoops">Boukloù</span><span id="Games_catMath">Matematik</span><span id="Games_catText">Testenn</span><span id="Games_catLists">Rolloù</span><span id="Games_catColour">Liv</span><span id="Games_catVariables">Argemmennoù</span><span id="Games_catProcedures">Arc\'hwelioù</span><span id="Games_httpRequestError">Ur gudenn zo gant ar reked.</span><span id="Games_linkAlert">Rannañ ho ploc\'hoù gant al liamm-mañ :\n\n%1</span><span id="Games_hashError">Digarezit. "%1" ne glot gant programm enrollet ebet.</span><span id="Games_xmlError">Ne c\'haller ket kargañ ho restr enrollet. Marteze e oa bet krouet gant ur stumm disheñvel eus Blockly ?</span><span id="Games_listVariable">roll</span><span id="Games_textVariable">testenn</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult.  Would you like to skip it and go onto the next game?  You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Nullañ</button><button id="abortOk" class="secondary">Mat eo</button></div></div>';
};
