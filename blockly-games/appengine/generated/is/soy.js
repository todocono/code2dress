...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Púsl</span><span id="Games_maze">Völundarhús</span><span id="Games_bird">Bird</span><span id="Games_turtle">Skjaldbaka</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Vista og tengja við kubba.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Keyra forritið</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Byrja aftur</span><span id="Games_help">Hjálp</span><span id="Games_dialogOk">Í lagi</span><span id="Games_dialogCancel">Hætta við</span><span id="Games_catLogic">Rökvísi</span><span id="Games_catLoops">Lykkjur</span><span id="Games_catMath">Reikningur</span><span id="Games_catText">Texti</span><span id="Games_catLists">Listar</span><span id="Games_catColour">Litir</span><span id="Games_catVariables">Breytur</span><span id="Games_catProcedures">Stefjur</span><span id="Games_httpRequestError">Það kom upp vandamál með beiðnina.</span><span id="Games_linkAlert">Deildu kubbunum þínum með þessari krækju:</span><span id="Games_hashError">Því miður, \'%1\' passar ekki við neitt vistað forrit.</span><span id="Games_xmlError">Gat ekki hlaðið vistuðu skrána þína. Var hún kannske búin til í annarri útgáfu af Blockly?</span><span id="Games_listVariable">listi</span><span id="Games_textVariable">texti</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult.  Would you like to skip it and go onto the next game?  You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Hætta við</button><button id="abortOk" class="secondary">Í lagi</button></div></div>';
};
