...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Skládačka</span><span id="Games_maze">Bludiště</span><span id="Games_bird">Bird</span><span id="Games_turtle">Želva</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Ulož a spoj bloky..</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Spusť program</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Reset</span><span id="Games_help">Nápověda</span><span id="Games_dialogOk">OK</span><span id="Games_dialogCancel">Zrušit</span><span id="Games_catLogic">Logika</span><span id="Games_catLoops">Smyčky</span><span id="Games_catMath">Matematika</span><span id="Games_catText">Text</span><span id="Games_catLists">Seznamy</span><span id="Games_catColour">Barva</span><span id="Games_catVariables">Proměnné</span><span id="Games_catProcedures">Procedury</span><span id="Games_httpRequestError">Došlo k potížím s požadavkem.</span><span id="Games_linkAlert">Sdílej bloky tímto odkazem: \n\n%1</span><span id="Games_hashError">Omlouváme se, \'%1\' nesouhlasí s žádným z uložených souborů.</span><span id="Games_xmlError">Nepodařilo se uložit vás soubor.  Pravděpodobně byl vytvořen jinou verzí Blockly?</span><span id="Games_listVariable">seznam</span><span id="Games_textVariable">text</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult.  Would you like to skip it and go onto the next game?  You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Zrušit</button><button id="abortOk" class="secondary">OK</button></div></div>';
};
